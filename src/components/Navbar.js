...
const Navbar = (props) => {
  ...
  const handleOnChange = (e) => {
    ...
    if (props.totalResults === 0) {
      console.alert("No result found for your search");
    }
  }
    return (
      <div>
          ...
          <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item dropdown ">
                  ...
                  <ul className="dropdown-menu">
                    <li className="nav-item"><Link className="dropdown-item" to="/">General</Link></li>
              ...
              <form className="d-flex" role="search">
                <input className="form-control me-2" value={msg} onChange={handleOnChange} type="search" placeholder="Search" aria-label="Search"/>
